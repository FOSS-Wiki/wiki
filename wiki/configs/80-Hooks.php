...
$wgHooks["SkinAddFooterLinks"][] = function ($sk, $key, &$footerlinks) {
    ...
    unset($footerlinks["about"], $footerlinks["privacy"], $footerlinks["disclaimers"]);
